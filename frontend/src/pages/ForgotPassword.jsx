        ...
        {submitted ? (
          ...
          <>
            <div className="text-center mb-6">
              <EnvelopeIcon className="w-12 h-12 text-sky-400 mx-auto mb-3" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                className="w-full py-3 bg-gradient-to-r from-sky-500 to-blue-600 text-white font-semibold rounded-xl disabled:opacity-50"
              >
            ...
            <div className="mt-6 text-center">
              <button
                type="button"
                onClick={() => navigate("/")}
                className="text-slate-400 hover:text-sky-300 font-semibold"
              >
                ← Back to Login
              </button>
            </div>
